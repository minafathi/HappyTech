...
<div style="color:red">
  ...
  <?php if(isset($_SESSION['upload1_error'])){ ?>
        <h3><?php print_r($this->session->userdata('upload1_error')); ?></h3>
    <?php } ?>
    <?php if(isset($_SESSION['upload2_error'])){ ?>
        <h3><?php print_r ($this->session->userdata('upload2_error')); ?></h3>
    <?php } ?>
    <?php if(isset($_SESSION['Successful_apply'])){ ?>
        <h3><?php echo $this->session->userdata('Successful_apply'); ?></h3>
    <?php } ?>
</div>
...
<?php echo form_open_multipart(base_url().'application_form/file_data');?> 
    <div class="form-wrap">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="custom-form custom-form-2">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <textarea class="form-control" name="work" id="work" cols="30" rows="2" required></textarea>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="uni" id="uni" required>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="fieldofstudy" id="fieldofstudy" required>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="custom-form terms-condition">
                        ...
                        <div class="form-check pl-0">
                            <input class="form-check-input mt-0 checkbox" type="checkbox" id="condition" name="condition" value="1" required>
